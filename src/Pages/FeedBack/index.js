...
const columns = {
  AllBlogs: [
    ...
    { Header: "Feedback details", accessor: "Feedback details" },
        ...
        blogs?.map((value, index) => ({
          ...
          view: (
            <IconButton
              ...
              onClick={() => {
                setIsOpenView(true);
                dispatch(getSingleBlog(`/getFeedbackById/${value?._id}/${admin}`));
              }}
            >
              <Visibility
          ...
          disable: (
            ...
            <IconButton
              ...
              onClick={() => {
                     dispatch(
                  updateBlog({
                    url: `${process.env.REACT_APP_API}/disablefeedback/${value?._id}/${admin}`,
                  })
                ).then((data) => {
                  dispatch(
                    handleAlert({
                  ...
                  if (data?.payload?.success) {
                    dispatch(getGlobalBlog(`/getAllFeedback`));
                  }
                });
              }}
            ...
            <Switch
              ...
              onChange={(e) => {
                ...
                dispatch(
                  ...
                  if (data?.payload?.success) {
                    dispatch(getGlobalBlog(`/getAllTactimonial`));
                  }
                });
              }}
              inputProps={{ "aria-label": "controlled" }}
            ...
            <>
              <IconButton
                ...
                onClick={() => {
                  ...
                  dispatch(getSingleBlog(`/getByTactimonialId/${value?._id}`));
                }}
              >
                <Edit
                  sx={({ palette: { dark, white, info } }) => ({
        ...
        <MDBox py={3}>
          <Card>
            ...
            >
              ...
              >
                <MDTypography variant="button">FeedBack Filter</MDTypography>
                <Select
