...
import { getSingleEHomeProduct } from "redux/festures/eHomeProduct";
import EproductDeails from "./EproductDeails";
...
const EHomeProduct = () => {
  ...
  useEffect(() => {
    dispatch(getEHomeProduct(`${process.env.REACT_APP_APII}/eCommerce/getAllHomeProduct/${admin}`));
  }, []);
            ...
            <>
              <IconButton
                ...
                onClick={() => {
                  ...
                  dispatch(getSingleEHomeProduct(value));
                }}
              >
                <Edit
  ...
  return (
    <>
      ...
      <SkConfirm
        dialogTitle={"Delete"}
        dialogContent={"Are you sure you want to delete this ecommerce home Product?"}
        open={isOpenDialog}
              ...
              onClick={() => {
                dispatch(
                  deleteSingleECategoryCart(
                    `${process.env.REACT_APP_APII}/eCommerce/deleteHomeProduct/${isOpenDialog?.isId}/${admin}`
                  )
                ).then((data) => {
                  dispatch(
                    handleAlert({
                  ...
                  if (data?.payload?.success) {
                    dispatch(
                      getEHomeProduct(
                        `${process.env.REACT_APP_APII}/eCommerce/getAllHomeProduct/${admin}`
                      )
                    );
                  }
                });
