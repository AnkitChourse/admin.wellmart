            ...
            >
              ...
              {singleHomeProduct?.products.map((ele, i) => (
                <>
                  ...
                  >
                    <MDTypography variant="h6"> Products Sold :</MDTypography>
                    <MDTypography variant="h6">{ele?.sold || "-"}</MDTypography>
                  </MDBox>
                  <MDBox
                    sx={({ palette: { dark, white, info }, breakpoints }) => ({
                      display: "flex",
                  ...
                  >
                    <MDTypography variant="h6"> Products stock :</MDTypography>
                    <MDTypography variant="h6">{ele?.stock || "-"}</MDTypography>
                  </MDBox>
                  <MDBox
                    sx={({ palette: { dark, white, info }, breakpoints }) => ({
                      display: "flex",
                  ...
                  >
                    <MDTypography variant="h6"> Products features :</MDTypography>
                    <MDBox width="50%">
                        {ele?.features.map((value,i)=>
                    <MDTypography variant="h6" key={i}>{value|| "-"},</MDTypography>
                    )}
                    </MDBox>
                  ...
                  >
                    ...
                    <MDTypography variant="h6">{ele?.reviewRating || "0"}</MDTypography>
                  </MDBox>
                  <MDBox
                    sx={({ palette: { dark, white, info }, breakpoints }) => ({
                      display: "flex",
                  ...
                  >
                    ...
                    <MDTypography variant="h6">{ele?.taxId || "0"}</MDTypography>
                  </MDBox>
                  <MDBox
                    sx={({ palette: { dark, white, info }, breakpoints }) => ({
                      display: "flex",
                  ...
                  >
                    ...
                    <MDTypography variant="h6">{ele?.time || "0"}</MDTypography>
                  </MDBox>
                  <MDBox
                    sx={({ palette: { dark, white, info }, breakpoints }) => ({
                      display: "flex",
