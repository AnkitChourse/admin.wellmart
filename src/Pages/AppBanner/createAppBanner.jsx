...
const CreateAppBanner = ({ isOpen, isOpenUpdate, setIsOpenUpdate, setIsOpen }) => {
      ...
      if (isOpenUpdate) {
        ...
        dispatch(
          updateSingleAppBanner({
            url: `${process.env.REACT_APP_APII}/updateAppBanner/${singleAppBanner?._id}/${admin}`,
            data: formData,
          })
        ).then((data) => {
          // console.log(data)
        ...
        dispatch(
          createAppBanner({
            url: `${process.env.REACT_APP_APII}/createAppBanner/${admin}`,
            data: formData,
          })
        ).then((data) => {
          dispatch(
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {" "}
            <MDButton disabled={appbannarLoading} color={"info"} verdant={"gradient"} type={"submit"}>
            {appbannarLoading ? (
