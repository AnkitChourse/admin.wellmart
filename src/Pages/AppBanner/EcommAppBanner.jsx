...
import EcomcreateAppBanner from "./EcomcreateAppBanner";
const columns = {
  AllBrands: [
          ...
          >
            ...
            <MDButton
              ...
              onClick={() => {
                dispatch(
                  deleteBrands(
                    `${process.env.REACT_APP_API}/eCommerce/deleteAppBanner/${isOpenDialog?.isId}/${admin}`
                  )
                ).then((data) => {
                  dispatch(
                    handleAlert({
